Game.PuntuacionesNoV = function(game){
};

Game.PuntuacionesNoV.prototype ={
	...
	create:function(){
		...
		var var1=Puntuacion_no_violento[0].split('|');
		var var2=Puntuacion_no_violento[1].split('|');
		var var3=Puntuacion_no_violento[2].split('|');
		var var4=Puntuacion_no_violento[3].split('|');
		var var5=Puntuacion_no_violento[4].split('|');
